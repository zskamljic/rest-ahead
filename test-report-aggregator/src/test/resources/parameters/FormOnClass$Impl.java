...
public final class FormOnClass$Impl implements FormOnClass {
    ...
    public FormOnClass$Impl(String baseUrl, Client client, DefaultAdapters defaultAdapters) {
    ...
    @Override
    public final void post(FormOnClass.Sample body) {
